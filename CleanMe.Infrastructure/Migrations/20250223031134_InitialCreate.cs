        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneHome = table.Column<string>(type: "VARCHAR(30)", maxLength: 30, nullable: true),
                    ...
                    IrdNumber = table.Column<string>(type: "VARCHAR(12)", maxLength: 12, nullable: true),
                    BankAccount = table.Column<string>(type: "VARCHAR(20)", maxLength: 20, nullable: true),
                    PayrollId = table.Column<string>(type: "VARCHAR(64)", nullable: true),
